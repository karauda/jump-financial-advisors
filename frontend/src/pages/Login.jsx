      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        ...
        <div className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-gray-700">
              <strong>Note:</strong> After logging in with Google, you'll be able to connect your HubSpot account to enable full functionality.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          ...
          <ul className="mt-2 space-y-1">
            <li>Gmail (read/write)</li>
            <li>Google Calendar (read/write)</li>
            <li>HubSpot CRM (optional)</li>
          </ul>
        </div>
      </div>
    </div>
